...
// 5. Isi form dengan password dan konfirmasi yang berbeda
...
driver.findElement(By.xpath("//input[contains(@placeholder,'email') or contains(@placeholder,'Email')]")).sendKeys("testnewuser999@gmail.com")
...
driver.findElement(By.xpath("//input[contains(@placeholder,'Konfirmasi')]")).sendKeys("BedaBanget999!")
