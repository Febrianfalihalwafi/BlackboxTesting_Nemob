...
driver.findElement(By.xpath("//input[contains(@placeholder,'email') or contains(@placeholder,'Email')]")).sendKeys("coffetelu1@gmail.com")
driver.findElement(By.xpath("//input[contains(@placeholder,'kata sandi') and not(contains(@placeholder,'Konfirmasi'))]")).sendKeys("1234567")
driver.findElement(By.xpath("//input[contains(@placeholder,'Konfirmasi')]")).sendKeys("1234567")
driver.findElement(By.xpath("//input[@type='tel' or contains(@placeholder,'62')]")).sendKeys("81234567890")
...
boolean isRegistrasiBerhasil = isiHalamanWeb.contains("berhasil") ||
                               isiHalamanWeb.contains("konfirmasi") ||
                               isiHalamanWeb.contains("email") ||
                               isiHalamanWeb.contains("login") ||
                               driver.getCurrentUrl().contains("login") ||
                               driver.getCurrentUrl().contains("dashboard")

assert isRegistrasiBerhasil == true : "GAGAL! Registrasi tidak berhasil."
println("Verifikasi Sukses! Akun berhasil dibuat.")
